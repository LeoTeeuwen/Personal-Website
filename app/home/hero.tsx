  ...
  return (
    <div className="flex flex-row justify-around mt-3 gap-x-4 text-main">
      <Link href={"https://github.com/LeoTeeuwen"} className='' target='_blank'>
        <button type="button"
          className="cursor-pointer mb-2 flex rounded bg-[#333] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
          <GithubIcon/>
          GitHub
        </button>
      </Link>
      <Link href={"https://www.linkedin.com/in/leo-teeuwen-560a3b2a9"} className='' target='_blank'>
        <button type="button"
          className="cursor-pointer mb-2 flex rounded bg-[#0077b5] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
          <LinkedInIcon/>
          Linkedin
        </button>
      </Link>
      <Link href="/resume" className='' target='_blank'>
        <button type="button"
          className="cursor-pointer mb-2 flex rounded bg-[#ea4335] px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg">
