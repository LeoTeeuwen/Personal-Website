    ...
    return (
        <div className='relative pb-[5%]'>
            <div className="w-full h-full absolute z-[-100]">
                <Image src="/oldWebsite/background_3.webp" fill loading="eager" alt="Loading..." className="aspect-16:9 blur-lg"/>
            </div>
            ...
            <div className='flex items-center flex-col'>
                <div className='max-w-[1500px] mx-[5%] bg-about-me-background bg-[#9f9f9f] dark:bg-d-about-me-background flex flex-col md:flex-row items-center rounded-2xl p-4 shadow-xl'>
                    ...
                    >
                        <Image width={4000} height={4000} priority src="/oldWebsite/aboutMeImage.jpg" alt="Image of self" className='h-max w-max rounded-xl' />
                    </m.div>
                </div>
            </div>
        </div>
